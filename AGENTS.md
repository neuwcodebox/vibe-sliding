...
1. **Classify the work.** Distinguish a new deck or broad redesign from an
   enhancement. Inspect `src/slides.ts`, the relevant components, and the
   selected theme before changing code.
